import {Heading,Text,Box,Image,SimpleGrid,Button, Container, flexbox,Input,breakpoint} from '@chakra-ui/react'
...
import { extendTheme } from '@chakra-ui/react'
 ...
 const Caro=()=>{
  ...
  >
    ...
    <Text>$5.95</Text>
    <Text fontSize="15px" textAlign="left" ml="60px">Limit 20 with code:ADORABLE</Text>
    <Link to="/products">
  ...
  <Box bg='white' height='190px' mt="30px" breakpoint="sm: '30em',
  md: '48em',
  lg: '62em',
  xl: '80em',
  '2xl': '96em',">
  <Heading fontSize="20px" color="blue" mt="5px" ml="40px">Limited Time only !</Heading>
    <Text textAlign="left" mt="15px" ml="80px">$35 with any$30purchase</Text>
    <Text fontSize="15px" textAlign="left" ml="80px" mt="10px">Limit 20 with code:ADORABLE</Text>
    <Link to="/products">
  ...
  <Box bg='white' height='170px' justifyContent="center" pt="50px"  mt="30px" breakpoint="sm: '30em',
  md: '48em',
  lg: '62em',
  xl: '80em',
  '2xl': '96em'," >
  <Text>All Hand Soaps</Text>
    ...
    <Button  bg="blackAlpha.800" color="white" borderRadius="0" mt="15px">SHOP</Button></Link>
  ...
  <Text textAlign="left" mt="15px" ml="22px">$35 with any$30purchase</Text>
    ...
    <Button  bg="blackAlpha.800" color="white" borderRadius="0" mt="15px">SHOP</Button>
        ...
        <Box width="85%" m="auto" mt="50px" mb="50" >
          <Link to="/products">
    ...
    <Box width="85%" mt="40px" m="auto" >
      <Link to="/products">
      <Image src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.21a/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dw315b64eb/images/Christmas2022/bc_core-gifting_c2_hm.jpg?yocs=s_" /></Link>
      
    </Box>
    <SimpleGrid minChildWidth='170px' width="85%" m="auto"  mt="50">
    ...
    <Box  >
      <Link to="/products">
      <Image src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.21a/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dw31e8f9db/images/Christmas2022/diff_innovation_c1_vn.jpg?yocs=o_s_" /></Link>
      <Text>Shop Wallflowers</Text>
    </Box>
    <Box>
      < Link to="/products">
      
      <Image src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.21a/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dw8ac572be/images/Christmas2022/sp_holtrads-gifting_c1_vn.jpg?yocs=o_s_" /></Link>
      <Text>Shop Hand Soap</Text>
    ...
    <Box width="85%" mt="30px"ml="100px">
      <Link t="/products">
      <Image src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.21a/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dw126cc0be/images/Christmas2022/xcat_hp-gifting-zone_c1_hb.jpg?yocs=s_" /></Link>
      
    </Box>
  
    <Box mt="50px"
 >
    <SimpleGrid spacing={5} minChildWidth='170px' width="85%" m="auto"  mt="50">
...
>
    ...
    <SimpleGrid minChildWidth='170px' width="85%" m="auto" >
    ...
    <Box mt="50px" justifyContent="left" breakpoint="
    sm: '30em',
    md: '48em',
    lg: '62em',
    xl: '80em',
    ...
    <SimpleGrid minChildWidth='170px' width="85%" m="auto" spacing={3}>
    <Box  height='280px'>
    ...
    <Box  height="200px" width="85%" ml="100px" mt="80px" 
  >
    ...
    <hr></hr>
    <SimpleGrid columns={5} spacing={10} textAlign="left" height="400px" mt="30px" fontWeight="light"
     width="85%" ml="100px"> 
  <Box  height='200px'  >
    <Heading fontSize="11px">GET EMAIL OFFERS & THE LATEST NEWS FROM BATH & BODY WORKS!</Heading>
    <Text mt="5px">Enter Email</Text>
    <Input mt="5px"color="black"></Input>
  ...
  <Box  height='200px'>
    <Heading as='h6' fontSize="15px" mb="10px" >CUSTOMER CARE</Heading>
  ...
  <Box  height='200px'>
  <Box  height='200px'>
    <Heading as='h6' fontSize="15px">MY ACCOUNT</Heading>
  ...
  <Box  height='200px'>
  <Box  height='200px'>
    <Heading as='h6' fontSize="15px">DISCOVER</Heading>
  ...
  <Box  height='200px'>
  <Heading as='h6' fontSize="15px">FIND US</Heading>
    <Text mt="10px">Store Locator</Text>
    <Text mt="10px">Global Location</Text>
  </Box>
</SimpleGrid>

<Box justifyContent="left" height="140px" bg="aliceblue" breakpoint="  sm: '30em',
  md: '48em',
  lg: '62em',
  xl: '80em',
  '2xl': '96em',">
  <Text>Terms Of Use  |  Privacy Policy  |  Security Bug Report  |  Privacy Rights (Certain States) | Do Not Sell or Share My Personal Information (Certain States) Transparency in Supply Chains | </Text>
  <Text>Targeted Ad Preferences (Certain States)   |   Limit the Use of My Sensitive Personal Information (California)</Text>
  <Text mt="40px" fontStyle="light">© 2022 Bath & Body Works Direct, Inc. All Rights Reserved.</Text>
</Box>
